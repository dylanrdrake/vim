...
if s:is_dark " DARK VARIANT
  ...
  let s:background   = ['#191919', '234'] " old bg was: #262626, 235
  ...
  let s:comment      = ['#8a8a8a', '240']
  let s:todo         = ['#ff8700', '208']
  let s:cursorline   = ['#303030', '235']
  let s:cursorlinenr = ['#ffff00', '209']
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call s:HL("cStatement", s:wine, "", "bold")
  ...
  call s:HL("nasmGen08Register", s:wine, "", "bold")
  call s:HL("nasmGen16Register", s:wine, "", "bold")
  call s:HL("nasmGen32Register", s:wine, "", "bold")
  call s:HL("nasmGen64Register", s:wine, "", "bold")
  call s:HL("nasmStorage", s:foreground, "", "bold")
  call s:HL("nasmLabel", s:blue, "", "bold")
  call s:HL("nasmLocalLabel", s:aqua, "", "bold")
  call s:HL("nasmDirective", s:gray, "", "bold")
  call s:HL("nasmInclude", s:gray, "", "bold")
  call s:HL("nasmDecNumber", s:foreground, "", "")
  call s:HL("nasmHexNumber", s:foreground, "", "")
  ...
  call s:HL("htmlTagName", s:orange, "", "")
  ...
  call s:HL("cssTableAttr", s:foreground, "", "")
  call s:HL("cssPositioningAttr", s:foreground, "", "")
  ...
  call s:HL("pythonBuiltinFunc", s:purple, "", "")
  ...
  call s:HL("clojureCond", s:purple, "", "bold")
  ...
  call s:HL("clojureRepeat", s:blue, "", "")
  call s:HL("clojureDispatch", s:wine, "", "")
